...
# کتابخانه استاندارد برای PDF (معمولاً در همه مخازن موجود است)
...
if uploaded_file and len(models) == 3:
    ...
    # --- ۶. بخش افزایشی برای دانلود PDF نهایی (اصلاح شده) ---
    if st.button("📥 Generate Clinical PDF Report"):
        ...
        href = f'<a href="data:application/pdf;base64,{b64}" download="Aariz_Report.pdf" style="text-decoration:none; background-color:#FF4B4B; color:white; padding:10px 20px; border-radius:8px;">Click here to Download PDF</a>'
