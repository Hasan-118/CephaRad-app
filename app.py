...
# --- ۳. رابط کاربری (UI) ---
st.set_page_config(page_title="Aariz Precision Station V17.0", layout="wide")
...
if uploaded_file and len(models) == 3:
    ...
    with col2:
        ...
        # ترسیم Co-A و Co-Gn و N-Perp (تکمیل شده طبق مرجع)
    ...
    # --- ۶. دکمه چاپ نهایی (عیناً طبق مرجع) ---
    if st.button("📥 مشاهده گزارش نهایی و پرینت"):
        ...
        <div style="font-family: Arial; padding: 20px; border: 3px solid black; direction: ltr;">
            ...
            <p><strong>Soft Tissue (E-Line):</strong> Upper {dist_ls}mm / Lower {dist_li}mm</p>
            <hr>
