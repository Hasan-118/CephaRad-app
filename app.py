...
# --- ۱. معماری مرجع Aariz (بدون تغییر - Gold Standard) ---
...
# --- ۲. لودر و توابع پیش‌بینی (مرجع V7.8) ---
@st.cache_resource
...
if uploaded_file and len(models) == 3:
    ...
    m3_col.metric("Downs (FMA)", f"{fma} deg")
    m4_col.metric("Soft Tissue (Li)", f"{dist_li}mm", f"Norm: -2mm")
